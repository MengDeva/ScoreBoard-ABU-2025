...
function changeTeam(team, png_name, name, side) {
  ...
  const sideElem = document.getElementById(`${team}TeamSide`);
  sideElem.textContent = side;

  // Make comparison case-insensitive
  if (side && side.toUpperCase() === "OFFENSIVE") {
    sideElem.style.backgroundColor = "#67AE6E";
    sideElem.style.color = "white";
  } else {
    sideElem.style.backgroundColor = "white";
    sideElem.style.color = "#000";
  }
}
